...
class _CalendarPageState extends State<CalendarPage> {
  ...
  void didChangeDependencies() {
    ...
    if (_tariffId == null && _tariffName == null) {
  ...
  void _loadQueryParameters() {
    ...
    final uri = state.uri;
    setState(() {
      _tariffId = uri.queryParameters['tariff'];
      _tariffName = uri.queryParameters['name'];
    });
  }
  ...
  void _handleContinue() {
    ...
    final uri = Uri(
      ...
      queryParameters: {
        ...
        if (_tariffId != null) 'tariff': _tariffId!,
        if (_tariffId != null) 'tariffId': _tariffId!,
        if (_tariffName != null) 'name': _tariffName!,
      },
    );
                  ...
                  child: Padding(
                    ...
                    child: TableCalendar(
                      ...
                      enabledDayPredicate: (day) {
                        return _isDateAvailable(day) && !_isDateBooked(day);
                      },
